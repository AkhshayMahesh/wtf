export default function Hero() {
	return (
		<section className="w-full px-4 sm:px-6 lg:pr-20 max-w-7xl mx-auto">
			...
			<button className="mt-8 w-full rounded-lg bg-black px-6 py-4 text-xl font-medium text-white shadow-sm hover:bg-gray-800 sm:mt-10 sm:w-auto sm:px-8 sm:py-5 sm:text-2xl">
				Article
			</button>
			<img
				...
				className="mt-6 w-full rounded-lg object-cover aspect-video"
			/>
		</section>
	);
}